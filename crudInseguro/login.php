...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($input_password)){
        ...
        echo "<script>alert('Por favor ingresa una contrasena de minimo 8 caracteres..')</script>";
    } else{
    ...
    if(empty($username_err) && empty($password_err)  ){
        ...
        $sql = "SELECT id, username FROM employees WHERE username='" . $username . "' AND password='" . $password . "';";
